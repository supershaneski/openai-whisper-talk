...
import { chat, embedding } from '../../services/openai'
...
export default defineEventHandler(async (event) => {
    ...
    if(function_name === 'add_calendar_entry') {
        ...
        await mongoDb.addCalendarEntry(function_args)

        api_output = { message: 'New event added' }
        ...
        api_output = { message: 'Entry deleted' }
